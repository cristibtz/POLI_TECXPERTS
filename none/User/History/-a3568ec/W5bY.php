            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    if(isset($_POST["submit"]))
                    {
                        ...
                        mysqli_stmt_prepare($stmt, $verify_q1);
                        mysqli_stmt_prepare($stmt, $verify_q2);
                        ...
                        $verify_q1_result = mysqli_stmt_get_result($verify_q1, MYSQLI_ASSOC);
                        $verify_q2_result = mysqli_fetch_array($verify_q2, MYSQLI_ASSOC);
