            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    if(isset($_POST["submit"]))
                    {
                        ...
                        $verify_q1 = sprintf("SELECT * FROM Users WHERE username = %s", mysqli_real_escape_string($conn, $username));
                        $verify_q2 = "SELECT * FROM Users WHERE email = '$email'";

                        $verify_q1_result = mysqli_query($conn, $verify_q1);
                        $verify_q2_result = mysqli_query($conn, $verify_q2);

                        $q1_rowCount = mysqli_num_rows($verify_q1_result);
                        $q2_rowCount = mysqli_num_rows($verify_q2_result);
