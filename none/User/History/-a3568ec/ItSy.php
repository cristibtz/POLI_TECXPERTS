            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    if(isset($_POST["submit"]))
                    {
                        ...
                        mysqli_stmt_prepare(mysqli_stmt_init($conn), $verify_q1);
                        mysqli_stmt_prepare(mysqli_stmt_init($conn), $verify_q2);

                        mysqli_stmt_bind_param(mysqli_stmt_init($conn), "s", $username);                        
                        mysqli_stmt_bind_param(mysqli_stmt_init($conn), "s", $email);
                        
                        mysqli_stmt_execute(mysqli_stmt_init($conn));
                        mysqli_stmt_execute(mysqli_stmt_init($conn));
